...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log('\n%cConectado a la BBDD', COLORS.blue)
    }
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log('%cYa estabamos conectados a la BBDD', COLORS.red);
      return;
    }

    this.connected = true;
    console.log('%cNueva conexion a la BBDD', COLORS.green);
  ...
  public disconnect(): void {
    // Completar: desconectar y mostrar mensaje de desconexión
     if (this.connected) {
      console.log('%cDesconectamos la conexion a la BBDD', COLORS.blue);
      this.connected = false;
      return;
    }

    console.log('%cNo hay una conexion activa a la BBDD', COLORS.red);
  }
}
